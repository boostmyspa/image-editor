...
<script>
    ...
    import BarLayerFontSize from './BarLayerFontSize';
    import BarLayerFontFamily from './BarLayerFontFamily';

    export default {
        name: "AddLayersButtons",
        ...
        components: {
            ...
            'bar-layer-font-size': BarLayerFontSize,
            'bar-layer-font-family': BarLayerFontFamily,
        },
